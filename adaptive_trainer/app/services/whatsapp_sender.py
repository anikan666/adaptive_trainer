...
async def send_message(to: str, text: str) -> dict:
    """Send a WhatsApp text message with retries and exponential backoff.
    ...
    Returns:
        The parsed JSON response from the WhatsApp API.

    Raises:
        httpx.HTTPStatusError: When the API returns a non-retryable error.
